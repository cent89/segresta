...
class SubscriptionController extends Controller
{
	...
	*/
	...
	public function print_subscription(Request $request, $id_subscription){
		...
		$comune = Comune::find($user->id_comune_nascita);
		$nazione = Nazione::find($user->id_nazione_nascita);
		$template->setValue('luogo_nascita', $comune != null?$comune->nome:$nazione->nome_stato);
		$template->setValue('data_nascita', $user->nato_il);
		$comune_residenza = Comune::find($user->id_comune_residenza);
