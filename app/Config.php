...
public static function getConfig(){
  return [
    ...
    ['key' => 'PRIVACY_AFFILIAZIONE_MOSTRA_REGISTRAZIONE', 'config' => 'app.privacy.affiliazione.registrazione.mostra', 'value' => true, 'display_name' => 'Mostra Affiliazione in fase d\'iscrizione', 'type' => 'boolean', 'group' => 'GDPR'],
    ['key' => 'PRIVACY_AFFILIAZIONE_OBBLIGATORIO_REGISTRAZIONE', 'config' => 'app.privacy.affiliazione.registrazione.obbligatorio', 'value' => true, 'display_name' => 'Accettazione Affiliazione vincolante per l\'iscrizione agli eventi', 'type' => 'boolean', 'group' => 'GDPR'],
